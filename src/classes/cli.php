...
use Velocite\Exception\CliException;
...
class Cli
{
     ...
     * @return string
     */
    public static function input($prefix = '') : string
    {
     ...
     * @throws CliException
     */
    public static function error($text = '', string $foreground = 'light_red', ?string $background = null) : void
    {
        if (is_array($text))
        {
            $text = implode(PHP_EOL, $text);
