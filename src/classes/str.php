...
class Str
{
    ...
    public static function alternator() : \Closure
    {
        ...
        return static function ($next = true) use ($args) {
            static $i = 0;
     ...
     */
    public static function strpos(string $haystack, $needle, int $offset = 0, ?string $encoding = 'UTF-8') : mixed
    {
        return (MBSTRING and $encoding)
     ...
     */
    public static function strrpos(string $haystack, $needle, int $offset = 0, ?string $encoding = 'UTF-8') : mixed
    {
        return (MBSTRING and $encoding)
     ...
     *               Returns FALSE if the needle was not found.
     */
    public static function stripos(string $haystack, $needle, int $offset = 0, ?string $encoding = 'UTF-8') : mixed
    {
        return (MBSTRING and $encoding)
     ...
     *               haystack string. If needle is not found, it returns FALSE.
     */
    public static function strripos(string $haystack, $needle, int $offset = 0, ?string $encoding = 'UTF-8') : mixed
    {
        return (MBSTRING and $encoding)
     ...
     */
    public static function strstr(string $haystack, $needle, bool $before_needle = false, ?string $encoding = 'UTF-8') : mixed
    {
        return (MBSTRING and $encoding)
     ...
     * @return mixed The portion of haystack, or FALSE if needle is not found
     */
    public static function stristr(string $haystack, $needle, bool $before_needle = false, ?string $encoding = 'UTF-8') : mixed
    {
        return (MBSTRING and $encoding)
     ...
     * @return mixed The portion of haystack, or FALSE if needle is not found
     */
    public static function strrchr(string $haystack, $needle, bool $before_needle = false, ?string $encoding = 'UTF-8') : mixed
    {
        return (MBSTRING and $encoding)
