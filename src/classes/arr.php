...
final class Arr
{
     ...
     * @return array
     */
    public static function assoc_to_keyval(array $assoc, string $key_field, string $val_field) : array
    {
     ...
     * @return array
     */
    public static function keyval_to_assoc(array $array, string $key_field, string $val_field) : array
    {
     ...
     */
    public static function to_assoc(array $arr) : ?array
    {
     ...
     * @return array
     */
    public static function flatten_assoc(array $array, string $glue = ':', bool $reset = true) : array
    {
     ...
     *
     * @param array    $array    the array to filter
     * @param callable $callback the callback that determines whether or not a value is filtered
     *
     * @return array
     */
     ...
     * @return array
     */
    public static function remove_prefixed(array $array, string $prefix) : array
    {
        foreach ($array as $key => $val)
        {
            if (preg_match('/^' . $prefix . '/', $key))
     ...
     * @return array
     */
    public static function filter_suffixed(array $array, string $suffix, bool $remove_suffix = true) : array
    {
        $return = [];
     ...
     * @return array
     */
    public static function remove_suffixed(array $array, string $suffix) : array
    {
        foreach ($array as $key => $val)
        {
            if (preg_match('/' . $suffix . '$/', $key))
     ...
     * @return array
     */
    public static function filter_keys(array $array, array $keys, bool $remove = false) : array
    {
        $return = [];
     ...
     * @return bool false when array shorter then $pos, otherwise true
     */
    public static function insert_assoc(array &$original, array $values, int $pos) : bool
    {
        if (count($original) < abs($pos))
        {
            return false;
     ...
     * @return array
     */
    public static function sort(array $array, string $key, string $order = 'asc', int $sort_flags = SORT_REGULAR) : array
    {
        if ( ! is_array($array))
        {
     ...
     * @return array
     */
    public static function merge_assoc() : array
    {
        $array  = func_get_arg(0);
        $arrays = array_slice(func_get_args(), 1);
     ...
     */
    public static function in_array_recursive($needle, array $haystack, bool $strict = false) : bool
    {
     ...
     */
    public static function is_multi(array $arr, bool $all_keys = false) : bool
    {
