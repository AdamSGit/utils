...
final class Arr
{
	 ...
	 * @return  mixed
	 */
	public static function delete(array &$array, string|array $key)
	{
		if (is_null($key))
		{
			return false;
	 ...
	 */
	public static function to_assoc(array $arr)
	{
	 ...
	 * @return  array
	 */
	public static function filter_recursive(array $array, ?callable $callback = null)
	{
