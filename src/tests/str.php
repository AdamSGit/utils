 ...
 * @group Str
 */
class Test_Str extends \PHPUnit\Framework\TestCase
{
    public function truncate_provider()
    {
        return [
            [15, 'Lorem ipsum dolor sit amet, Пиочинаючюи adipiscing elit.'],
            [1, '<p><a href="https://example.org/image.jpg"><img src="https://example.org/image.jpg"></a></p><p>other text</p>'],
        ];
    }
     ...
     * @param mixed $string
     */
    public function test_truncate_plain($limit, $string) : void
    {
     ...
     * @param mixed $string
     */
    public function test_truncate_custom_continuation($limit, $string) : void
    {
        $expected = $limit === 1 ? '<..' : 'Lorem ipsum dol..';
     ...
     * @param mixed $string
     */
    public function test_truncate_not_html($limit, $string) : void
    {
        $expected = $limit === 1 ? '<...' : 'Lorem ipsum dol...';
     ...
     * @param mixed $string
     */
    public function test_truncate_is_html($limit, $string) : void
    {
     ...
     * @param mixed $string
     */
    public function test_truncate_multiple_tags($limit, $string) : void
    {
        $limit  = 400;
