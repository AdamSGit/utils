 ...
 * @group Validation
 */
class Test_Validation extends \PHPUnit\Framework\TestCase
{
     ...
     * @param mixed $input
     */
    public function test_validation_required_success($input) : void
    {
     ...
     * @param mixed $input
     */
    public function test_validation_required_failure($input) : void
    {
        $val = Validation::forge(__FUNCTION__);
     ...
     * @param mixed $input
     */
    public function test_validation_match_value_success($input) : void
    {
        $val = Validation::forge(__FUNCTION__);
     ...
     * @param mixed $input
     */
    public function test_validation_match_value_failure($input) : void
    {
        $val = Validation::forge(__FUNCTION__);
     ...
     * @param mixed $input
     */
    public function test_validation_match_value_strict_success($input) : void
    {
        $val = Validation::forge(__FUNCTION__);
     ...
     * @param mixed $input
     */
    public function test_validation_match_value_strict_failure($input) : void
    {
        $val = Validation::forge(__FUNCTION__);
        $val->add_field('php', 'PHP', '')->add_rule('match_value', '1', 1);
        $val->run($input);
     ...
     * @param mixed $input
     */
    public function test_validation_match_collection_success($input) : void
    {
        $val = Validation::forge(__FUNCTION__);
     ...
     * @param mixed $input
     */
    public function test_validation_match_collection_failure($input) : void
    {
        $val = Validation::forge(__FUNCTION__);
        $val->add_field('gender', 'Gender', 'match_collection["M,F"]');
        $val->run($input);
     ...
     * @param mixed $input
     */
    public function test_validation_match_collection_strict_success($input) : void
    {
        $val = Validation::forge(__FUNCTION__);
        $val->add_field('gender', 'Gender', '')->add_rule('match_collection', ['M', 'F'], true);
     ...
     * @param mixed $input
     */
    public function test_validation_match_collection_strict_failure($input) : void
    {
        $val = Validation::forge(__FUNCTION__);
        $val->add_field('gender', 'Gender', '')->add_rule('match_collection', ['m', 'f'], true);
        $val->run($input);
     ...
     * @param mixed $input
     */
    public function test_validation_match_pattern_success($input) : void
    {
        $val = Validation::forge(__FUNCTION__);
     ...
     * @param mixed $input
     */
    public function test_validation_match_pattern_failure($input) : void
    {
        $val = Validation::forge(__FUNCTION__);
     ...
     * @param mixed $input
     */
    public function test_validation_match_field_success($input) : void
    {
        $val = Validation::forge(__FUNCTION__);
     ...
     * @param mixed $input
     */
    public function test_validation_match_field_failure($input) : void
    {
        $val = Validation::forge(__FUNCTION__);
     ...
     * @param mixed $input
     */
    public function test_validation_min_length_success($input) : void
    {
        $val = Validation::forge(__FUNCTION__);
     ...
     * @param mixed $input
     */
    public function test_validation_min_length_failure($input) : void
    {
        $val = Validation::forge(__FUNCTION__);
     ...
     * @param mixed $input
     */
    public function test_validation_max_length_success($input) : void
    {
        $val = Validation::forge(__FUNCTION__);
     ...
     * @param mixed $input
     */
    public function test_validation_max_length_failure($input) : void
    {
        $val = Validation::forge(__FUNCTION__);
     ...
     * @param mixed $input
     */
    public function test_validation_exact_length_success($input) : void
    {
        $val = Validation::forge(__FUNCTION__);
     ...
     * @param mixed $input
     */
    public function test_validation_exact_length_failure($input) : void
    {
        $val = Validation::forge(__FUNCTION__);
        $val->add_field('boo', 'Boo', 'max_length[2]');
        $val->run($input);
     ...
     * @param mixed $input
     */
    public function test_validation_valid_email_success($input) : void
    {
        $val = Validation::forge(__FUNCTION__);
     ...
     * @param mixed $input
     */
    public function test_validation_valid_email_failure($input) : void
    {
        $val = Validation::forge(__FUNCTION__);
     ...
     * @param mixed $input
     */
    public function test_validation_valid_emails_success($input) : void
    {
        $val = Validation::forge(__FUNCTION__);
     ...
     * @param mixed $input
     */
    public function test_validation_valid_emails_separator_success($input) : void
    {
        $val = Validation::forge(__FUNCTION__);
     ...
     * @param mixed $input
     */
    public function test_validation_valid_emails_failure($input) : void
    {
        $val = Validation::forge(__FUNCTION__);
     ...
     * @param mixed $input
     */
    public function test_validation_valid_url_success($input) : void
    {
        $val = Validation::forge(__FUNCTION__);
     ...
     * @param mixed $input
     */
    public function test_validation_valid_url_failure($input) : void
    {
        $val = Validation::forge(__FUNCTION__);
     ...
     * @param mixed $input
     */
    public function test_validation_valid_ip_success($input) : void
    {
        $val = Validation::forge(__FUNCTION__);
     ...
     * @param mixed $input
     */
    public function test_validation_valid_ip_failure($input) : void
    {
        $val = Validation::forge(__FUNCTION__);
     ...
     * Expecting:   success
     */
    public function test_validation_valid_ip_v6_only_success() : void
    {
        $val = Validation::forge(__FUNCTION__);
        $val->add_field('ipv6', 'IPv6 address', 'valid_ip[ipv6]');

        $output = $val->run(['ipv6' => '2001:0db8:85a3:08d3:1319:8a2e:0370:7334']);
     ...
     * Expecting:   failure
     */
    public function test_validation_valid_ip_v6_only_failure() : void
    {
        $val = Validation::forge(__FUNCTION__);
        $val->add_field('ipv6', 'IPv6 address', 'valid_ip[ipv6]');

        $output = $val->run(['ipv6' => '192.168.0.1']);
     ...
     * Expecting:   failure
     */
    public function test_validation_valid_ip_v4_only_failure() : void
    {
        $val = Validation::forge(__FUNCTION__);
        $val->add_field('ipv4', 'IPv4 address', 'valid_ip[ipv4]');

        $output = $val->run(['ipv4' => '2001:0db8:85a3:08d3:1319:8a2e:0370:7334']);
     ...
     * @param mixed $input
     */
    public function test_validation_numeric_min_success($input) : void
    {
        $val = Validation::forge(__FUNCTION__);
     ...
     * @param mixed $input
     */
    public function test_validation_numeric_min_failure($input) : void
    {
        $val = Validation::forge(__FUNCTION__);
     ...
     * @param mixed $input
     */
    public function test_validation_numeric_max_success($input) : void
    {
        $val = Validation::forge(__FUNCTION__);
     ...
     * @param mixed $input
     */
    public function test_validation_numeric_max_failure($input) : void
    {
        $val = Validation::forge(__FUNCTION__);
     ...
     * @param mixed $input
     */
    public function test_validation_numeric_between_success($input) : void
    {
        $val = Validation::forge(__FUNCTION__);
     ...
     * @param mixed $input
     */
    public function test_validation_numeric_between_failure($input) : void
    {
        $val = Validation::forge(__FUNCTION__);
     ...
     * @param mixed $input
     */
    public function test_validation_required_with_success($input) : void
    {
        $val = Validation::forge(__FUNCTION__);
        $val->add_field('foo', 'Foo', 'valid_string');
     ...
     * Expecting:   success
     */
    public function test_validation_valid_string_numeric_success() : void
    {
        $post = [
            'f1' => '123456',
        ];
     ...
     * Expecting:   failure
     */
    public function test_validation_valid_string_numeric_failure() : void
    {
        $post = [
            'f1' => 'a123456',
        ];
     ...
     * Expecting:   failure
     */
    public function test_validation_valid_string_multiple_flags_error_message_add_rule() : void
    {
        $post = [
            'f1' => '123 abc',
        ];
        ...
        $val = Validation::forge(__FUNCTION__);
        $val->add('f1', 'F1')->add_rule('valid_string', ['alpha', 'numeric']);
     ...
     * Expecting:   failure
     */
    public function test_validation_valid_string_multiple_flags_error_message_add_field() : void
    {
        $post = [
            'f1' => '123 abc',
        ];
     ...
     * Expecting:   success
     */
    public function test_validation_valid_date_none_arguments() : void
    {
        $post = [
            'f1' => '2013/02/26',
            'f2' => '2013-02-26',
     ...
     * Expecting:   failure
     */
    public function test_validation_valid_date_none_arguments_error() : void
    {
        $post = [
            'f1' => 'test',
        ];
     ...
     * Expecting:   failure
     */
    public function test_validation_valid_date_none_arguments_strict_error() : void
    {
        $post = [
            'f1' => '2013/02/29',
        ];
     ...
     * Expecting:   success
     */
    public function test_validation_valid_date_format() : void
    {
        $post = [
            'f1' => '2013/02/26',
            'f2' => '2013-02-26',
     ...
     * Expecting:   failure
     */
    public function test_validation_valid_date_format_error() : void
    {
        $post = [
            'f1' => '2013/02/26',
        ];
     ...
     * Expecting:   success
     */
    public function test_validation_valid_date_not_strict() : void
    {
        $post = [
            'f1' => '2013/02/29',
        ];
