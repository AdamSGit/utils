 ...
 * @group Crypt
 */
class Test_Crypt extends \PHPUnit\Framework\TestCase
{
    ...
    public function test_legacy_decode() : void
    {
    ...
    public function test_encode_decode_with_key() : void
    {
    ...
    public function test_encode_decode_large_data() : void
    {
